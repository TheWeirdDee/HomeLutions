    ...
    <section className="bg-blue-100 py-16 px-6 md:px-20">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1">
          <p className="text-2xl text-blue-950 font-semibold mb-2 frunchy">WE CAN HELP YOU</p>
          ...
          <div className="mb-4">
            <div className="flex justify-between mb-1">
              <span className="text-sm font-medium text-gray-700 font">Job Success Rate</span>
              <span className="text-lg font-medium text-gray-700 chloe">92%</span>
            </div>
          ...
          <div className="mb-6">
            <div className="flex justify-between mb-1">
              <span className="text-sm font-medium text-gray-700 font">Customer Satisfaction</span>
              <span className="text-lg chloe font-medium text-gray-700">98%</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-3">
