      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <form onSubmit={handleSubmit}>
            <textarea
              className="w-full border border-gray-400 rounded-md p-3 text-sm resize-none focus:outline-none focus:border-yellow-500 mb-4"
              rows="4"
            ...
            <button
              type="submit"
              className="bg-blue-950 text-white px-5 py-2 rounded hover:bg-black transition"
            >
              Submit Question
            </button>
          </form>
