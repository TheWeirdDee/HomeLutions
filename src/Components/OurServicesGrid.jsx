    ...
    <div className="bg-gray-100 py-12 px-4 sm:px-6 lg:px-20" id="services">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          ...
          <h2 className="md:text-3xl text-2xl font-bold text-gray-900 frunchy">
            What Can We Offer
          </h2>
          <h3 className="md:text-3xl text-2xl font-bold text-gray-900 frunchy">
            As Your Handyman
          </h3>
        </div>
        ...
        {services.map((service, index) => (
          ...
          >
            ...
            <h3 className="text-lg font-bold text-gray-800 mb-2 font">
              {service.title}
            </h3>
            <p className="text-gray-600 text-md playfair">
              {service.description}
            </p>
            <a
              href="#"
