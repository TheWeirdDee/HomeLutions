...
import HeroImage from "../assets/HowHero.png";
    ...
    <section className="bg-blue-950 text-white py-16 px-6 md:px-16 flex flex-col md:flex-row items-center justify-between">
      <div className="md:w-1/2 mb-10 md:mb-0">
        ...
        <p className="text-gray-300 mb-6 playfair tracking-wider text-lg">
          Find Your <span className="text-blue-300">Service,</span> Book an
          Appointment, Track Your Job in Real-Time, Rate and Review Your
          Experience, <br /> Get Ongoing Support.
        </p>
