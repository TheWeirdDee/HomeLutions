...
const ContactPage = () => {
  return (
    <section className="bg-blue-50 py-16 px-4 mt-15">
      <div className="max-w-6xl mx-auto bg-white rounded-xl shadow-md p-8 md:p-12 flex flex-col md:flex-row gap-10">
        ...
        <div className="md:w-1/2">
          ...
          <form className="space-y-4">
            <div>
              <label className="block text-lg font-medium text-gray-700 playfair">Full Name</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-lg font-medium text-gray-700 playfair">Email</label>
              <input
                type="email"
                className="playfair text-md w-full mt-1 p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div>
              <label className="playfair block text-lg font-medium text-gray-900">Message</label>
              <textarea
                rows="4"
