    ...
    <section className="bg-blue-950 text-white py-16 px-6 md:px-16 flex flex-col md:flex-row items-center justify-between">
      <div className="md:w-1/2 mb-10 md:mb-0">
        ...
        <p className="text-gray-300 mb-6 playfair tracking-wider text-md">
          Homelutions was born out of a simple need, making home repairs easy,
          reliable, and stress-free. We connect busy homeowners with skilled
          professionals who take pride in quality work and exceptional service.
        </p>
      ...
      <div className="md:w-1/2 flex justify-center">
        <img src={HeroImage} alt="Cleaning Lady" className="w-full max-w-md" />
      </div>
    </section>
  );
};
